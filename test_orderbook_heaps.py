...
def test_add_single_order_price_levels(empty_OrderBookSide):
    order_book_side = empty_OrderBookSide
    ...
    assert order_book_side.price_levels[50].price == 50
    assert order_book_side.price_levels[50].quantity == 1
...
def test_add_single_order_linked_list(empty_OrderBookSide):
    ...
    assert order_book_side.price_levels[50].head_order_node is order_node
    assert order_book_side.price_levels[50].tail_order_node is order_node
...
def test_add_multiple_orders_same_price_price_levels(empty_OrderBookSide):
    order_book_side = empty_OrderBookSide
    ...
    for i in range(len(prices)):
        ...
        assert order_book_side.price_levels[50].price == 50
        assert order_book_side.price_levels[50].quantity == i + 1
...
def test_add_multiple_orders_same_price_linked_list(empty_OrderBookSide):
    ...
    assert order_book_side.price_levels[50].head_order_node is order_nodes[0]
    assert order_book_side.price_levels[50].tail_order_node is order_nodes[2]
...
def test_add_multiple_orders_different_price_price_levels(empty_OrderBookSide):
    order_book_side = empty_OrderBookSide
    ...
    for i, price in enumerate([50, 51, 52]):
        assert order_book_side.price_levels[price].price == price
        assert order_book_side.price_levels[price].quantity == quantity[i]
...
def test_add_multiple_orders_different_price_linked_list(empty_OrderBookSide):
    ...
    assert order_book_side.price_levels[50].head_order_node is order_nodes[0]
    assert order_book_side.price_levels[50].tail_order_node is order_nodes[0]
    assert order_book_side.price_levels[51].head_order_node is order_nodes[2]
    assert order_book_side.price_levels[51].tail_order_node is order_nodes[2]
    assert order_book_side.price_levels[52].head_order_node is order_nodes[1]
    assert order_book_side.price_levels[52].tail_order_node is order_nodes[3]
...
def test_cancel_single_order_price_levels(empty_OrderBookSide):
    order_book_side = empty_OrderBookSide
    ...
    assert order.price not in order_book_side.price_levels
...
def test_cancel_multiple_orders_price_levels(empty_OrderBookSide):
    order_book_side = empty_OrderBookSide
    ...
    for i, price in enumerate([51, 52]):
        assert order_book_side.price_levels[price].price == price
        assert order_book_side.price_levels[price].quantity == quantity[i]
    assert 50 not in order_book_side.price_levels
...
def test_cancel_multiple_orders_linked_lists(empty_OrderBookSide):
    ...
    assert order_book_side.price_levels[51].tail_order_node is order_nodes[2]
    assert order_book_side.price_levels[52].head_order_node is order_nodes[1]
    assert order_book_side.price_levels[52].tail_order_node is order_nodes[5]
...
def test_match_single_order_best_price(empty_OrderBook):
    ...
    assert order_book.buy_side.best_price is None



def test_match_single_order_price_levels(empty_OrderBook):
    order_book = empty_OrderBook
    ...
    assert order.price not in order_book.buy_side.price_levels
...
def test_match_multiple_orders_price_levels(empty_OrderBook):
    order_book = empty_OrderBook
    ...
    for i, price in enumerate([50, 51]):
        assert order_book.buy_side.price_levels[price].price == price
        assert order_book.buy_side.price_levels[price].quantity == quantity[i]
    assert 52 not in order_book.buy_side.price_levels
...
def test_match_multiple_orders_linked_lists(empty_OrderBook):
    ...
    assert order_book.buy_side.price_levels[50].head_order_node is order_nodes[1]
    assert order_book.buy_side.price_levels[50].tail_order_node is order_nodes[5]
    assert order_book.buy_side.price_levels[51].head_order_node is order_nodes[3]
    assert order_book.buy_side.price_levels[51].tail_order_node is order_nodes[3]